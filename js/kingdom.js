    ...
    //localStorage.resultsarray=[];
    //vratemp=[]
    //var temp=localStorage.resultsarray;
    //temp.push('b')
    //localStorage.resultsarray=temp
    //alert(localStorage.resultsarray)

    if (typeof localStorage.resultsarray == 'undefined'){
        localStorage.resultsarray=[];
    }
            ...
            if (moves.uci.length && !stalemate_by_rules) {
                ...
                if (board.get_mode() === "play") {
                    ...
                    if (moves.checkers.length && !stalemate_by_rules) {
                        ...
                        if((board.turn === "b" ? "White" : "Black")=='Black'){
                            ...
                            var xhr = new XMLHttpRequest();
                                        ...
                                        var moves=moves.fen.full_move_counter;
                                       
                                        var url='**backend**?result=1&moves='+moves+'&contempt='+contempt;
                            ...
                            var xhr = new XMLHttpRequest();
                                        ...
                                        var url='**backend**?result=0&moves='+moves+'&contempt='+contempt;
                                        xhr.open("POST", url, true);
                                        //Send the proper header information along with the request
                                        xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                                        xhr.send();
                        ...
                        //localStorage.resultsarray.push((board.turn === "b" ? "White" : "Black") + " wins!")
                    start_new_game()
                    } else {
                        if (stalemate_by_rules) {
                            ...
                            var xhr = new XMLHttpRequest();
                                        ...
                                        var url='**backend**?result=2&moves='+moves+'&contempt='+contempt;
                                        xhr.open("POST", url, true);
                                        //Send the proper header information along with the request
                                        xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                                        xhr.send();
                            ...
                            start_new_game()
                                ...
                                //localStorage.resultsarray.push("Stalemate: Three-fold repetition")
                              if(String(window.location).includes('?')){
                                    var contempt=1;
                                }else{
                                    var contempt=0; 
                            ...
                            var xhr = new XMLHttpRequest();
                                        ...
                                        var url='**backend**?result=3&moves='+moves+'&contempt='+contempt;
                                        xhr.open("POST", url, true);
                                        //Send the proper header information along with the request
                                        xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                                        xhr.send();
                            ...
                            start_new_game()
                                ...
                                //localStorage.resultsarray.push("Stalemate: Insufficient material")
                                if(String(window.location).includes('?')){
                                    var contempt=1;
                                }else{
                                    var contempt=0; 
                            ...
                            var xhr = new XMLHttpRequest();
                                        ...
                                        var url='**backend**?result=4&moves='+moves+'&contempt='+contempt;
                                        xhr.open("POST", url, true);
                                        //Send the proper header information along with the request
                                        xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                                        xhr.send();
                            ...
                            //localStorage.resultsarray.push("Stalemate: else");
                            ...
                            var xhr = new XMLHttpRequest();
                                        ...
                                        var url='**backend**?result=5&moves='+moves+'&contempt='+contempt;
                                        xhr.open("POST", url, true);
                                        //Send the proper header information along with the request
                                        xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                                        xhr.send();
    ...
    function start_new_game(shamalamadingdong)
    {

        if(typeof shamalamadingdong == 'undefined'){
            shamalamadingdong=false;
        }
           if (shamalamadingdong){
    var externalview=true
}else{
